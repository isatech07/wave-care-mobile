...
const styles = StyleSheet.create({
  ...
  label:            { fontFamily: 'Poppins_400Regular', fontSize: 10, color: INACTIVE_COLOR, fontWeight: '400' },
  labelActive:      { color: ACTIVE_COLOR, fontFamily: 'Poppins_600SemiBold', fontWeight: '600' },
  ...
  sheetTitle:  { fontFamily: 'Poppins_600SemiBold', fontSize: 13, fontWeight: '600', color: '#888', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 12 },
  ...
  estacaoLabel:         { fontFamily: 'Poppins_400Regular', flex: 1, fontSize: 16, color: '#333', fontWeight: '400' },
  estacaoLabelSelected: { color: ACTIVE_COLOR, fontFamily: 'Poppins_600SemiBold', fontWeight: '600' },
