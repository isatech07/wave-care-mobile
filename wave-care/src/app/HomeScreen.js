...
const ESTACOES = [
  ...
  { key: 'inverno', label: 'Primavera', sub: 'Restauração e Cuidado',         image: require('../../assets/products/primavera-produtos/propaganda-primavera.png') },
];
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <FlatList
            ...
            contentContainerStyle={styles.estacaoList}
            renderItem={({ item }) => (
