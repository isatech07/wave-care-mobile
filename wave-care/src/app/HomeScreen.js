...
function HomeContent({ onQuizPress, onEstacaoPress, onAddToLoja }) {
  return (
          ...
          <View key={p.id} style={styles.produtoCard}>
            ...
            <View style={styles.produtoInfo}>
              ...
              <View style={styles.produtoFooter}>
                ...
                <TouchableOpacity style={styles.addBtn} onPress={() => onAddToLoja(p)}>
