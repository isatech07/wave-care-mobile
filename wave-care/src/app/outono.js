      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <Animated.Text style={[styles.heroSub, subAnim]}>
            ...
            folhas caindo e mudancas de clima, com brilho terroso e leveza.
          </Animated.Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionSub}>
            O kit mais completo da estacao para nutricao e equilibrio dos seus fios
          </Text>
          <ProductCard
            name="Kit Autumn Total Nutrition"
            desc="Kit completo com shampoo, condicionador, mascara e oleo nutritivo para dias frios"
            price="R$ 229,90"
            oldPrice="R$ 249,90"
            stars="4.8"
            reviews="250"
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.highlightsRow, { marginTop: 14 }]}>
            <HighlightCard iconName="leaf" title="Sazonal" text="Ativos da estacao de colheita" delay={200} />
            <HighlightCard iconName="flask" title="Clinico" text="Testes para climas de transicao" delay={350} />
            <HighlightCard iconName="refresh" title="Consciente" text="Embalagens com foco sustentavel" delay={500} />
          </View>
        </View>
        ...
        <View style={styles.ctaCard}>
          ...
          <Text style={styles.ctaCardSub}>
            Combine produtos e ganhe ate 20% de desconto na sua linha Autumn personalizada.
          </Text>
