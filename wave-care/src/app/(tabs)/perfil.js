...
export default function perfil() {
  ...
  const getInitials = () => user.name ? user.name.slice(0, 2).toUpperCase() : '?';
...
const styles = StyleSheet.create({
  ...
  safeGuest: { flex: 1, backgroundColor: '#f5f5f0' },
  scroll: { flex: 1 },
  guestScreen: { flex: 1 },
  backBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8, gap: 4 },
  backText: { color: GREEN, fontSize: 16, fontWeight: '500' },
  guestContent: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 30, paddingBottom: 80 },
  guestIconCircle: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#e8f4f1', alignItems: 'center', justifyContent: 'center', marginBottom: 20 },
  guestTitle: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 20, fontWeight: 'bold', color: '#333', marginBottom: 10, textAlign: 'center' },
  guestSubtitle: { fontFamily: 'Poppins_400Regular', fontSize: 14, color: '#777', textAlign: 'center', lineHeight: 22, marginBottom: 30 },
  loginBtn: { backgroundColor: GREEN, paddingVertical: 14, borderRadius: 25, width: '100%', alignItems: 'center', marginBottom: 12 },
  loginBtnText: { color: '#fff', fontWeight: 'bold', fontSize: 15 },
  registerBtn: { borderWidth: 1.5, borderColor: GREEN, paddingVertical: 13, borderRadius: 25, width: '100%', alignItems: 'center' },
  registerBtnText: { color: GREEN, fontWeight: 'bold', fontSize: 15 },
  header: { alignItems: 'center', paddingTop: 32, paddingBottom: 24, backgroundColor: '#fff', borderBottomLeftRadius: 24, borderBottomRightRadius: 24, marginBottom: 12 },
  avatarWrapper: { position: 'relative', marginBottom: 14 },
  avatarImage: { width: 88, height: 88, borderRadius: 44, borderWidth: 3, borderColor: GREEN },
  avatarPlaceholder: { width: 88, height: 88, borderRadius: 44, backgroundColor: GREEN, alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: '#e8f4f1' },
  avatarInitials: { color: '#fff', fontSize: 28, fontWeight: 'bold' },
  cameraOverlay: { position: 'absolute', bottom: 2, right: 2, width: 26, height: 26, borderRadius: 13, backgroundColor: GREEN, borderWidth: 2, borderColor: '#fff', alignItems: 'center', justifyContent: 'center' },
  userName: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 18, fontWeight: 'bold', color: '#222' },
  userEmail: { fontFamily: 'Poppins_400Regular', fontSize: 13, color: '#888', marginTop: 4 },
  tabs: { flexDirection: 'row', backgroundColor: '#fff', marginHorizontal: 8, borderRadius: 14, marginBottom: 12, overflow: 'hidden' },
  tabBtn: { flex: 1, alignItems: 'center', paddingVertical: 14, paddingHorizontal: 4, position: 'relative' },
  tabText: { fontFamily: 'Poppins_500Medium', fontSize: 12, color: '#aaa', fontWeight: '500' },
  tabTextActive: { color: GREEN, fontWeight: '700' },
  tabIndicator: { position: 'absolute', bottom: 0, left: '15%', right: '15%', height: 3, backgroundColor: GREEN, borderTopLeftRadius: 2, borderTopRightRadius: 2 },
  card: { backgroundColor: '#fff', marginHorizontal: 12, marginBottom: 12, padding: 18, borderRadius: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 2 },
  fieldGroup: { marginBottom: 14 },
  fieldLabel: { fontSize: 11, color: '#aaa', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
  fieldValue: { fontFamily: 'Poppins_400Regular', fontSize: 15, color: '#333' },
  input: { borderWidth: 1, borderColor: '#ddd', padding: 10, borderRadius: 10, fontSize: 14, color: '#222', backgroundColor: '#fafafa' },
  row: { flexDirection: 'row', gap: 10, marginTop: 8 },
  btn: { flex: 1, padding: 12, borderRadius: 10, alignItems: 'center' },
  btnSave: { backgroundColor: GREEN },
  btnCancel: { backgroundColor: '#eee' },
  btnText: { fontWeight: '600', color: '#fff', fontSize: 14 },
  editBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 10, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: GREEN + '44', backgroundColor: GREEN + '0A' },
  editText: { color: GREEN, fontWeight: '600', fontSize: 14 },
  orderHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  orderId: { fontWeight: 'bold', fontSize: 15, color: '#222' },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  badgeText: { color: '#fff', fontSize: 11, fontWeight: 'bold' },
  timeline: { flexDirection: 'row', marginVertical: 14 },
  timelineStep: { flex: 1, alignItems: 'center' },
  timelineBar: { height: 4, width: '100%', marginBottom: 6, borderRadius: 2 },
  timelineLabel: { fontSize: 9, color: '#888', textAlign: 'center' },
  sectionTitle: { fontFamily: 'Poppins_600SemiBold', fontWeight: '600', fontSize: 13, color: '#555', marginBottom: 8 },
  productRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' },
  productName: { fontSize: 14, color: '#333' },
  productPrice: { fontSize: 14, color: GREEN, fontWeight: '500' },
  ...
  totalValue: { fontWeight: 'bold', fontSize: 15, color: GREEN },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, paddingHorizontal: 12, marginBottom: 12 },
  favoriteCard: { width: '47%', backgroundColor: '#fff', borderRadius: 14, padding: 12, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
  favoriteImage: { width: 72, height: 72, borderRadius: 36, marginBottom: 8 },
  favoriteImagePlaceholder: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#f0f0f0', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  favoriteName: { fontSize: 13, color: '#333', textAlign: 'center', marginBottom: 4 },
  favoritePrice: { fontSize: 13, color: GREEN, fontWeight: '600' },
  hairRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16, gap: 12 },
  hairIconWrap: { width: 40, height: 40, borderRadius: 20, backgroundColor: GREEN + '15', alignItems: 'center', justifyContent: 'center' },
  hairTextWrap: { flex: 1 },
  hairLabel: { fontSize: 11, color: '#aaa', textTransform: 'uppercase', letterSpacing: 0.4 },
  hairValue: { fontSize: 15, color: '#222', fontWeight: '500', marginTop: 2 },
  refazerQuizBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 6, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: GREEN + '44' },
  refazerQuizText: { color: GREEN, fontWeight: '600', fontSize: 14 },
  quizPrompt: { alignItems: 'center', paddingVertical: 16 },
  quizIconCircle: { width: 72, height: 72, borderRadius: 36, backgroundColor: GREEN + '15', alignItems: 'center', justifyContent: 'center', marginBottom: 14 },
  quizTitle: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 16, fontWeight: 'bold', color: '#222', marginBottom: 8, textAlign: 'center' },
  quizSubtitle: { fontFamily: 'Poppins_400Regular', fontSize: 13, color: '#777', textAlign: 'center', lineHeight: 20, marginBottom: 20 },
  quizBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: GREEN, paddingHorizontal: 28, paddingVertical: 12, borderRadius: 25 },
  ...
  emptyAction: { marginTop: 16, paddingHorizontal: 24, paddingVertical: 10, borderRadius: 20, backgroundColor: GREEN },
  emptyActionText: { color: '#fff', fontWeight: '600', fontSize: 14 },
  configItem: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' },
  configText: { fontFamily: 'Poppins_500Medium', fontSize: 15, color: '#333' },
  configDangerText: { color: '#d32f2f' },
  modalOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', justifyContent: 'center', zIndex: 999 },
  modalBox: { backgroundColor: '#fff', borderRadius: 16, padding: 24, marginHorizontal: 32, width: '85%' },
  modalTitle: { fontSize: 17, fontWeight: 'bold', color: '#222', marginBottom: 10 },
  modalMessage: { fontSize: 14, color: '#555', lineHeight: 20, marginBottom: 24 },
  modalButtons: { flexDirection: 'row', gap: 10 },
  modalBtnCancel: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: '#eee', alignItems: 'center' },
  modalBtnCancelText: { color: '#555', fontWeight: '600', fontSize: 14 },
  modalBtnConfirm: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: GREEN, alignItems: 'center' },
